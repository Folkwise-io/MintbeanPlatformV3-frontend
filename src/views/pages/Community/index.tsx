...
const Community: FC<void> = () => {
  const headerArgs = {
    ...
    body: `At Mintbean, we give you an active and engaged platform where you can build the habit of code. Bring your eagerness to learn, and practice your skills with developers of all levels.
