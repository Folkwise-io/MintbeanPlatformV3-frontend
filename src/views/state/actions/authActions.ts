    ...
    return context.authService
      ...
      .then((user: User) => {
        ...
        context.loggerService.success(
          `<p>Welcome back, ${user.firstName}!</p><p>Check out our <u><strong><a href="/meets" style="color:black;">Upcoming Meets</a></strong></u> to get hacking!</p>`,
        );
  ...
  return (dispatch: Dispatch, getState, context) => {
    ...
    return context.authService
      ...
      .then((user: User) => {
        ...
        context.loggerService.success(
          `Welcome to Mintbean, ${user.firstName}!<p>Check out our <u><strong><a href="/meets" style="color:black;">Upcoming Meets</a></strong></u> to get hacking!</p>`,
        );
