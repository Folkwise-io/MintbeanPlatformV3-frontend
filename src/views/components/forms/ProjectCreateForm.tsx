...
const createProjectInputSchema = yup.object().shape({
  ...
  sourceCodeUrl: yup
    .string()
    .url("Source code URL must be a valid URL (with protocol like https://)")
    .required("Source code URL required!"),
  liveUrl: yup
    .string()
    .url("Deployment URL must be a valid URL (with protocol like https://)")
    .required("Deployment URL required!"),
